...
def main():
    ...
    hyperparams = {
        ...
        "pt_func": AttrDict({"output_dim": 10})
    }
...
if __name__ == '__main__':
    try:
        ...
        print(f'Experiment for {args.num_iterations} - {args.borf_batch_add} - {args.borf_batch_remove} disrupted...')
    finally:
        print(f'Experiment for {args.num_iterations} - {args.borf_batch_add} - {args.borf_batch_remove} done.')
